...
public class AStarSearch {
    ...
    private void findPath(){
        ...
        while(true) {
            ...
            if((current.getPosition().getX() == -1) && (current.getPosition().getY() == -1)) {
                System.out.println("NO WAY OUT OF THIS HELL!!!!!!!!!!");
                findPathWithBear();
                break;
            }
    ...
    private void findPathWithBear(){
        System.out.println("Start Path with bears");
        ...
        StarNode leftNeighbour = null, upNeighbour = null, rightNeighbour = null, downNeighbour = null;
        StarNode goal = field[WoodCutter.getRealPosition().getX()][WoodCutter.getRealPosition().getY()];
        goal.setPosition(WoodCutter.getRealPosition().getX(), WoodCutter.getRealPosition().getY());
        ...
        while(true) {
            ...
            System.out.println("HAS NOT BREAK");
            ...
            if(currentCell.isBear()) {
                numberOfBears--;

                System.out.println("Current cell is bear");
            }
            ...
            //If we have reach the goal
            if((current.getPosition().getX() == goal.getPosition().getX()) && (current.getPosition().getY() == goal.getPosition().getY())){
                findPath();//Start find path to granny
                return;
            }
            ...
            if((upCell != null) && ((upCell.isWolf()) || (upCell.isBear() && numberOfBears < 1)) && (upNeighbour != null)) {
                System.out.println("Up: " + (upCell.isBear() && numberOfBears < 1));//TODO
                upNeighbour.setTraversable(false);
            }
            if((downCell != null) && ((downCell.isWolf()) || (downCell.isBear() && numberOfBears < 1)) && (downNeighbour != null)) {
                System.out.println("Down: " + (downCell.isBear() && numberOfBears < 1));//TODO
                downNeighbour.setTraversable(false);
            }
            if((leftCell != null) && ((leftCell.isWolf()) || (leftCell.isBear() && numberOfBears < 1)) && (leftNeighbour != null)) {
                System.out.println("Left: " + (leftCell.isBear() && numberOfBears < 1));//TODO
                leftNeighbour.setTraversable(false);
            }
            if((rightCell != null) && ((rightCell.isWolf()) || (rightCell.isBear() && numberOfBears < 1)) && (rightNeighbour != null)) {
                System.out.println("Right: " + (rightCell.isBear() && numberOfBears < 1));//TODO
                rightNeighbour.setTraversable(false);
            }
