...
public class Constants {
    ...
    public final static String CLOSED_SYMBOL = "✕";

    public final static String PATH_SYMBOL = "▧";
    public final static String GRASS_SYMBOL = "✕";

    public final static int CLOSED_CELL = 0;
